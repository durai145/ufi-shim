define(["jquery","ufi.core", "ufi.frameGen","ufi.xml","ufi.validate"], function($,uficore,ufiframegen,ufixml,ufivalidate) {
...
OutJsonTextId.value=    "[{" +us.frameGenerationJson(schemaJson[0].childs,
  schemaJson[0]
) +"}]";
...
LangResoureId.value=    "[{" +us.frameGenerationResoure(schemaJson[0].childs,
  schemaJson[0]
)  +"}]";
...
document.getElementById( "GenXmlJsonB").onclick =function ()
{
    ...
    XMLJsonId.value= xml.genChilTagJson(parentId.value);
